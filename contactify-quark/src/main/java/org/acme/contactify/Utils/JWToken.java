...
public class JWToken {
    ...
    public static String generateToken(String username, Set<AccountRole> roles, Long duration, String issuer) throws Exception {
    ...
    public static PrivateKey readPrivateKey(final String pemResName) throws Exception {
        try (InputStream contentIS = JWToken.class.getResourceAsStream(pemResName)) {
